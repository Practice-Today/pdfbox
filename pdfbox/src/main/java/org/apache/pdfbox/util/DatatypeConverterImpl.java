 ...
 * @since JAXB 2.1
 */
public final class DatatypeConverterImpl {//TODO implements DatatypeConverterInterface {

    /**
     * To avoid re-creating instances, we cache one instance.
     */
    public static final DatatypeConverterImpl theInstance = new DatatypeConverterImpl();
   ...
   public BigInteger parseInteger(String lexicalXSDInteger) {
        return new BigInteger(String.valueOf(lexicalXSDInteger));//TODO _parseInteger(lexicalXSDInteger);
    }
...
//        return StringType.theInstance.convertToLexicalValue( val, null );
     ...
     */
    /*TODO public static String installHook(String s) {
        DatatypeConverterImpl.setDatatypeConverter(theInstance);
        return s;
    }*/
    // base64 decoder
    ...
    static {
        try {
            datatypeFactory = null;//TODO DatatypeFactory.newInstance();
